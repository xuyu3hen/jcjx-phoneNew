...
part of 'repair_plan_list.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RepairPlanList _$RepairPlanListFromJson(Map<String, dynamic> json) =>
    RepairPlanList(
      code: json['code'] as int?,
      msg: json['msg'] as String?,
      total: json['total'] as int?,
      rows: (json['rows'] as List<dynamic>?)
          ?.map((e) => RepairPlan.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$RepairPlanListToJson(RepairPlanList instance) =>
    <String, dynamic>{
...
RepairPlan _$RepairPlanFromJson(Map<String, dynamic> json) => RepairPlan(
