...
class JtShow extends StatefulWidget {
  const JtShow({Key? key}) : super(key: key);
  @override
  State<JtShow> createState() => _JtShowPageState();
}

class _JtShowPageState extends State<JtShow> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: pageNum >= ((total - 1) ~/ pageSize) + 1
                                  ? null
                                  : () {
                                      setState(() {
                                        pageNum++;
