            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Text('机型: ${train['trainType']}'), // 假设车型信息在 'trainType' 字段中
                      const SizedBox(width: 10), // 添加一些间距
                      Text('车号: ${train['trainNum']}'), // 假设车号信息在 'trainNumber' 字段中
                      const SizedBox(width: 10), // 添加一些间距
                      Text('预计上台日期: ${train['arrivePlatformTime']}'), // 假设到达平台时间信息在 'arrivePlatFormTime' 字段中
                    ],
                  ),
                ),
              );
      ...
      body: teamList.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  leading: Checkbox(
                    value: team['associated'] ?? false, // 假设 associated 字段表示是否已关联
                    onChanged: (value) {
                      setState(() {
                  ...
                  title: Text(' ${team['deptName']}'), // 假设班组名称信息在 'deptName' 字段中
                  subtitle: team['associated'] == true ? const Text('承修班组') : null, // 显示承修班组字段
                );
              },
            ),
