...
import '/zjc_common/utils/zjc_status_bar_utils.dart';
...
//      icon: Icon(Icons.arrow_back_ios,color: _color),
      icon: ImageIcon(const AssetImage('assets/ic_nav_back_white.png'), color: titleAndIconColor),
      iconSize: 18,
    ...
    return AppBar(
      ...
      systemOverlayStyle: ZjcStatusBarUtils.getStatusBarStyle(isDark: isDark, brightness: brightness),
