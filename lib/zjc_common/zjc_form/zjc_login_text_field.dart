...
import '../utils/zjc_color_utils.dart';
...
class ZjcLoginTextField extends StatefulWidget {
  const ZjcLoginTextField({
    Key? key,
    this.text = '',
    this.hintText = '',
    this.labelText,
  ...
  @override
  State<ZjcLoginTextField> createState() => _ZjcLoginTextFieldState();
}

class _ZjcLoginTextFieldState extends State<ZjcLoginTextField> {
...
//      _pwdImg = _pwdShow?ImageIcon(AssetImage('assets/images/ic_pwd_close.png')):ImageIcon(AssetImage('assets/images/ic_pwd_open.png')) ;
    ...
    return Theme(
      ...
      data: ThemeData(
        ...
        primarySwatch: ZjcColorUtils.materialColor(themeColor),
