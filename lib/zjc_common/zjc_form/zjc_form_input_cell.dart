...
class ZjcFormInputCell extends StatefulWidget {
  const ZjcFormInputCell({
    Key? key,
    this.title = '',
    this.text = '',
    this.labelText = '',
  ...
  @override
  State<ZjcFormInputCell> createState() => _ZjcFormInputCellState();
}

class _ZjcFormInputCellState extends State<ZjcFormInputCell> {
  @override
