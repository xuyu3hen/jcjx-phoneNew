...
import '../zjc_form/zjc_searchbar.dart';
import '/zjc_common/utils/zjc_common_utils.dart';
import '/config/colors.dart';
// import '/project/provider/theme_provider.dart';
// import '/common/routes/jh_nav_utils.dart';
    ...
    return !widget.isShowSearch
        ...
        : Container(
            ...
            child: ZjcSearchBar(
              ...
              text: _searchKeyword,
              inputCallBack: ZjcCommonUtils.debounceInput((value) {
                setState(() {
