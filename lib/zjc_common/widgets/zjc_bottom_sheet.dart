...
import '../utils/zjc_screen_utils.dart';
...
class _JhBottomSheetViewState extends State<JhBottomSheetView> {
  ...
  _body() {
    ...
    return Container(
      color: bgColor,
      height: bgHeight + ZjcScreenUtils.bottomSafeHeight,
      child: Column(
        children: <Widget>[
          Container(
            color: bgColor,
          ...
          GestureDetector(
            child: Container(
              padding: EdgeInsets.only(bottom: ZjcScreenUtils.bottomSafeHeight),
              height: _cellHeight + ZjcScreenUtils.bottomSafeHeight,
              color: bgColor,
              child: Center(
                child: Text(
                  _cancelText,
