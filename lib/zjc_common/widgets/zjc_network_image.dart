...
/// 加载网络图片
/// 使用：ZjcNetworkImage(model.avatarUrl.jhNullSafe, placeholder: 'ic_placeholder', width: 75, height: 75, borderRadius: 10),
///
/// image: NetworkImage('https://xxx.png'),
/// widget: Image.network('https://xxx.png', fit: BoxFit.cover, width: 50, height: 50.0),
class ZjcNetworkImage extends StatelessWidget {
  const ZjcNetworkImage(
    this.image, {
    Key? key,
