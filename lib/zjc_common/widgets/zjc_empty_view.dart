...
const String _emptyImagePath = 'assets/empty/ic_empty.png';
const String _networkErrorImagePath = 'assets/empty/ic_netErr.png';

enum EmptyType { empty, error, loading }

class ZjcEmptyView extends StatefulWidget {
  const ZjcEmptyView({
    Key? key,
  ...
  @override
  State<ZjcEmptyView> createState() => _ZjcEmptyViewState();
}

class _ZjcEmptyViewState extends State<ZjcEmptyView> {
  @override
